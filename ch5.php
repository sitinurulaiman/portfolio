...
<?php
  ...
  if (isset($_POST['upload'])) {
	  ...
	  $target = "./upload/chp5/".basename($newfileName);
  ...
  $result = mysqli_query($db, "SELECT * FROM chp5");
?>
<!DOCTYPE html>
		<html>
				<head>
        ...
        * {
		...
		img{
			...
			<div class="page-content">
				...
				<div class="picColumn">
                            <img src="img/TOPIC 5-DEV QUALITY PLAN-1.png" alt="" width="1100" height="700"></a> 
                            </div>
                           
                            <div class="picColumn">
							  <img src="img/TOPIC 5-DEV QUALITY PLAN-2.png" alt="" width="1100" height="700"></a>
                            </div>
                            
                        <div class="picColumn">
						 <img src="img/TOPIC 5-DEV QUALITY PLAN-3.png" alt="" width="1100" height="700"></a> 
                            </div>
                            <div class="picColumn">
                            <img src="img/TOPIC 5-DEV QUALITY PLAN-4.png" alt="" width="1100" height="700"></a> 
                            </div>
                           
                            <div class="picColumn">
							  <img src="img/TOPIC 5-DEV QUALITY PLAN-5.png" alt="" width="1100" height="700"></a>
                            </div>
                            
                        <div class="picColumn">
						 <img src="img/TOPIC 5-DEV QUALITY PLAN-6.png" alt="" width="1100" height="700"></a> 
							</div>
							<div class="picColumn">
                            <img src="img/TOPIC 5-DEV QUALITY PLAN-7.png" alt="" width="1100" height="700"></a> 
                            </div>
                           
                            <div class="picColumn">
							  <img src="img/TOPIC 5-DEV QUALITY PLAN-8.png" alt="" width="1100" height="700"></a>
                            </div>
		   ...
		   <br></br>
            <div class="section-heading">
				...
				<center>	<?php
					...
					?>
					<br>
  					<form  method="POST" action="ch5.php" enctype="multipart/form-data">
				...
				<div class="container">
					...
					<p style="color:yellow" style="font: italic;">Write your comment here !!
						...
						<form action="ch5.php" method="POST" class="p-2">
						...
						?>
							<div class="card mb-2 border-secondary">
								...
								<div class="card-footer-py-2">
									...
									<a href="ch5.php?edit=<?= $row['id'] ?>" class="text-success" title="Edit"><i class="fas fa-edit"></i></a>
								</div>
							</div>
					</div>
						<?php } ?>
