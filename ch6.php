...
<?php
  ...
  if (isset($_POST['upload'])) {
	  ...
	  $target = "./upload/chp6/".basename($newfileName);
  ...
  $result = mysqli_query($db, "SELECT * FROM chp6");
?>
<!DOCTYPE html>
		<html>
				<head>
        ...
        * {
		...
		img{
			...
			<div class="page-content">
				...
				<div class="picColumn">
                            <img src="img/TOPIC 6-DESIGN REVIEW-01.png" alt="" width="1100" height="700"></a> 
                            </div>
                           
                            <div class="picColumn">
							  <img src="img/TOPIC 6-DESIGN REVIEW-02.png" alt="" width="1100" height="700"></a>
                            </div>
                            
                        <div class="picColumn">
						 <img src="img/TOPIC 6-DESIGN REVIEW-03.png" alt="" width="1100" height="700"></a> 
                            </div>
                            <div class="picColumn">
                            <img src="img/TOPIC 6-DESIGN REVIEW-04.png" alt="" width="1100" height="700"></a> 
                            </div>
                           
                            <div class="picColumn">
							  <img src="img/TOPIC 6-DESIGN REVIEW-05.png" alt="" width="1100" height="700"></a>
                            </div>
                            
                        <div class="picColumn">
						 <img src="img/TOPIC 6-DESIGN REVIEW-06.png" alt="" width="1100" height="700"></a> 
							</div>
							<div class="picColumn">
                            <img src="img/TOPIC 6-DESIGN REVIEW-07.png" alt="" width="1100" height="700"></a> 
                            </div>
                           
                            <div class="picColumn">
							  <img src="img/TOPIC 6-DESIGN REVIEW-08.png" alt="" width="1100" height="700"></a>
                            </div>
							<div class="picColumn">
							  <img src="img/TOPIC 6-DESIGN REVIEW-09.png" alt="" width="1100" height="700"></a>
                            </div>
                            
                        <div class="picColumn">
						 <img src="img/TOPIC 6-DESIGN REVIEW-10.png" alt="" width="1100" height="700"></a> 
							</div>
							<div class="picColumn">
                            <img src="img/TOPIC 6-DESIGN REVIEW-11.png" alt="" width="1100" height="700"></a> 
                            </div>
                           
                            <div class="picColumn">
							  <img src="img/TOPIC 6-DESIGN REVIEW-12.png" alt="" width="1100" height="700"></a>
                            </div>
		   ...
		   <br></br>
            <div class="section-heading">
				...
				<center>	<?php
					...
					?>
					<br>
  					<form  method="POST" action="ch6.php" enctype="multipart/form-data">
				...
				<div class="container">
					...
					<p style="color:yellow" style="font: italic;">Write your comment here !!
						...
						<form action="ch6.php" method="POST" class="p-2">
						...
						?>
							<div class="card mb-2 border-secondary">
								...
								<div class="card-footer-py-2">
									...
									<a href="ch6.php?edit=<?= $row['id'] ?>" class="text-success" title="Edit"><i class="fas fa-edit"></i></a>
								</div>
							</div>
					</div>
						<?php } ?>
