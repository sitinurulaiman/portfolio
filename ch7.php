...
<?php
  ...
  if (isset($_POST['upload'])) {
	  ...
	  $target = "./upload/chp7/".basename($newfileName);

	  if(in_array($fileExt, $allowedExt)) {
		if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) 
			{
				$sql = "INSERT INTO chp5 (image_name, image_path) VALUES ('$image', '$target')";
				// execute query
				mysqli_query($db, $sql);
  ...
  $result = mysqli_query($db, "SELECT * FROM chp7");
?>
<!DOCTYPE html>
		<html>
				<head>
        ...
        * {
		...
		img{
			...
			<div class="page-content">
				...
				<div class="picColumn">
                            <img src="img/TOPIC 7-SOFTWARE TESTING - STRATEGIES-01.png" alt="" width="1100" height="700"></a> 
                            </div>
                           
                            <div class="picColumn">
							  <img src="img/TOPIC 7-SOFTWARE TESTING - STRATEGIES-02.png" alt="" width="1100" height="700"></a>
                            </div>
                            
                        <div class="picColumn">
						 <img src="img/TOPIC 7-SOFTWARE TESTING - STRATEGIES-03.png" alt="" width="1100" height="700"></a> 
                            </div>
                            <div class="picColumn">
                            <img src="img/TOPIC 7-SOFTWARE TESTING - STRATEGIES-04.png" alt="" width="1100" height="700"></a> 
                            </div>
                           
                            <div class="picColumn">
							  <img src="img/TOPIC 7-SOFTWARE TESTING - STRATEGIES-05.png" alt="" width="1100" height="700"></a>
                            </div>
                            
                        <div class="picColumn">
						 <img src="img/TOPIC 7-SOFTWARE TESTING - STRATEGIES-06.png" alt="" width="1100" height="700"></a> 
							</div>
							<div class="picColumn">
                            <img src="img/TOPIC 7-SOFTWARE TESTING - STRATEGIES-07.png" alt="" width="1100" height="700"></a> 
                            </div>
                           
                            <div class="picColumn">
							  <img src="img/TOPIC 7-SOFTWARE TESTING - STRATEGIES-08.png" alt="" width="1100" height="700"></a>
                            </div>
							<div class="picColumn">
							  <img src="img/TOPIC 7-SOFTWARE TESTING - STRATEGIES-09.png" alt="" width="1100" height="700"></a>
                            </div>
                            
                        <div class="picColumn">
						 <img src="img/TOPIC 7-SOFTWARE TESTING - STRATEGIES-10.png" alt="" width="1100" height="700"></a> 
							</div>
							<div class="picColumn">
                            <img src="img/TOPIC 7-SOFTWARE TESTING - STRATEGIES-11.png" alt="" width="1100" height="700"></a> 
                            </div>
            ...
            <div class="section-heading">
				...
				<div class="container">
					...
					<p style="color:yellow" style="font: italic;">Write your comment here !!
						...
						<form action="ch7.php" method="POST" class="p-2">
						...
						?>
							<div class="card mb-2 border-secondary">
								...
								<div class="card-footer-py-2">
									...
									<a href="ch7.php?edit=<?= $row['id'] ?>" class="text-success" title="Edit"><i class="fas fa-edit"></i></a>
								</div>
							</div>
					</div>
						<?php } ?>
