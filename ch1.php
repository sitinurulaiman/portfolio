...
<?php
  ...
  if (isset($_POST['upload'])) {
	  ...
	  $target = "./upload/chp1/".basename($newfileName);

	  if(in_array($fileExt, $allowedExt)) {
		if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) 
			{
				$sql = "INSERT INTO chp1 (image_name, image_path) VALUES ('$image', '$target')";
				// execute query
				mysqli_query($db, $sql);
  ...
  $result = mysqli_query($db, "SELECT * FROM chp1");
?>
<!DOCTYPE html>
		<html>
				<head>
		...
		img{
			...
			<div class="page-content">
                <div class="masonry">
                            ...
                            <div class="picColumn">
                            <img src="img/tajuk1.jpg" alt="" width="1100" height="700"></a> 
                            </div>
			...
			<h4 style="color:bisque;text-align:center; font-size:400px> ">Do share your note and leave comment for us here ><
					</h4>
		   <br></br>
		   <br></br>
            <div class="section-heading">
				...
				<center>	<?php
					...
					?>
					<br>
  					<form  method="POST" action="ch1.php" enctype="multipart/form-data">
				...
				<div class="container">
					...
					<p style="color:white" style="font: italic;">Write your comment here !!
				</p>
						<div class="col-lg-12"></div>
						<form action="ch1.php" method="POST" class="p-2">
						...
						?>
							<div class="card mb-2 border-secondary">
								...
								<div class="card-footer-py-2">
									...
									<a href="ch1.php?edit=<?= $row['id'] ?>" class="text-success" title="Edit"><i class="fas fa-edit"></i></a>
								</div>
							</div>
					</div>
						<?php } ?>
