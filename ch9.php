...
<?php
  ...
  if (isset($_POST['upload'])) {
	  ...
	  $target = "./upload/chp9/".basename($newfileName);

	  if(in_array($fileExt, $allowedExt)) {
		if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) 
			{
				$sql = "INSERT INTO chp9 (image_name, image_path) VALUES ('$image', '$target')";
				// execute query
				mysqli_query($db, $sql);
  ...
  $result = mysqli_query($db, "SELECT * FROM chp9");
?>
<!DOCTYPE html>
		<html>
				<head>
        ...
        * {
		...
		img{
			...
			<div class="page-content">
				...
				<div class="picColumn">
                            <img src="img/TOPIC 9-SOFTWARE MAINTENANCE-1.png" alt="" width="1100" height="700"></a> 
                            </div>
                           
                            <div class="picColumn">
							  <img src="img/TOPIC 9-SOFTWARE MAINTENANCE-2.png" alt="" width="1100" height="700"></a>
                            </div>
                            
                        <div class="picColumn">
						 <img src="img/TOPIC 9-SOFTWARE MAINTENANCE-3.png" alt="" width="1100" height="700"></a> 
                            </div>
                            <div class="picColumn">
                            <img src="img/TOPIC 9-SOFTWARE MAINTENANCE-4.png" alt="" width="1100" height="700"></a> 
                            </div>
                           
                            <div class="picColumn">
							  <img src="img/TOPIC 9-SOFTWARE MAINTENANCE-5.png" alt="" width="1100" height="700"></a>
                            </div>
                            
                        <div class="picColumn">
						 <img src="img/TOPIC 9-SOFTWARE MAINTENANCE-6.png" alt="" width="1100" height="700"></a> 
							</div>
		   ...
		   <br></br>
            <div class="section-heading">
				...
				<center>	<?php
					...
					?>
					<br>
  					<form  method="POST" action="ch9.php" enctype="multipart/form-data">
				...
				<div class="container">
					...
					<p style="color:yellow" style="font: italic;">Write your comment here !!
						...
						<form action="ch9.php" method="POST" class="p-2">
						...
						?>
							<div class="card mb-2 border-secondary">
								...
								<div class="card-footer-py-2">
									...
									<a href="ch9.php?edit=<?= $row['id'] ?>" class="text-success" title="Edit"><i class="fas fa-edit"></i></a>
								</div>
							</div>
					</div>
						<?php } ?>
