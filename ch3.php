...
<?php
  ...
  if (isset($_POST['upload'])) {
	  ...
	  $target = "./upload/chp3/".basename($newfileName);

	  if(in_array($fileExt, $allowedExt)) {
		if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) 
			{
				$sql = "INSERT INTO chp3 (image_name, image_path) VALUES ('$image', '$target')";
				// execute query
				mysqli_query($db, $sql);
  ...
  $result = mysqli_query($db, "SELECT * FROM chp3");
?>
<!DOCTYPE html>
		<html>
				<head>
		...
		img{
			...
			<div class="page-content">
                <div class="masonry">
                            ...
                            <div class="picColumn">
                            <img src="img/tajuk3.jpg" alt="" width="1100" height="700"></a> 
                            </div>
		   ...
		   <br></br>
            <div class="section-heading">
				<div id="content">
					...
					?>
					<br>
  					<form  method="POST" action="ch3.php" enctype="multipart/form-data">
				...
				<div class="container">
					...
					<p style="color:yellow" style="font: italic;">Write your comment here !!
						...
						<form action="ch3.php" method="POST" class="p-2">
						...
						?>
							<div class="card mb-2 border-secondary">
								...
								<div class="card-footer-py-2">
									...
									<a href="ch3.php?edit=<?= $row['id'] ?>" class="text-success" title="Edit"><i class="fas fa-edit"></i></a>
								</div>
							</div>
					</div>
						<?php } ?>
